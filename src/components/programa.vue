<template>
  <v-card class="containerGridPrograma">
    ...
    <v-btn color="light-blue accent-4" class="btnVistaPrevia" :flat="mobile" dark @click="">vista previa</v-btn>
    <v-btn color="grey darken-3" class="btnConfirmar" :flat="mobile" dark @click="">guardar</v-btn>
